package com.ccd.filing.test.view.custom.ripplebutton;
...
public class RippleButton extends Button {
    ...
    private boolean mIsRippleing=false;
    ...
    public RippleButton(Context context, AttributeSet attrs, int defStyle) {
        ...
        mRippleColor = a.getColor(R.styleable.RippleView_rippleButtonColor,
                mRippleColor);
    ...
    public boolean onTouchEvent(final MotionEvent event) {
        ...
        if (event.getActionMasked() == MotionEvent.ACTION_DOWN
            ...
            mRadiusAnimator = ObjectAnimator.ofFloat(this, "radius", 0, dp(5))
                    .setDuration(1000);
            mRadiusAnimator
            ...
            mRadiusAnimator = ObjectAnimator.ofFloat(this, "radius", dp(5),
                    targetRadius);
